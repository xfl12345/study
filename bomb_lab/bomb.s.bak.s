...
08049477 <phase_0>:
 ...
 8049480:	68 94 a1 04 08       	push   $0x804a194
 8049485:	ff 75 08             	pushl  0x8(%ebp)
 8049488:	e8 e7 06 00 00       	call   8049b74 <strings_not_equal>
 804948d:	83 c4 10             	add    $0x10,%esp
 8049490:	85 c0                	test   %eax,%eax
 8049492:	74 0c                	je     80494a0 <phase_0+0x29>
 8049494:	e8 43 09 00 00       	call   8049ddc <explode_bomb>
...
080494a7 <phase_1>:
 ...
 80494ad:	c7 45 f4 41 85 2e 11 	movl   $0x112e8541,-0xc(%ebp)
 ...
 80494c1:	50                   	push   %eax
 80494c2:	68 c9 a1 04 08       	push   $0x804a1c9
 ...
 80494e6:	8b 10                	mov    (%eax),%edx
 80494e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 80494eb:	39 c2                	cmp    %eax,%edx
 80494ed:	75 0f                	jne    80494fe <phase_1+0x57>
 80494ef:	8d 45 e8             	lea    -0x18(%ebp),%eax
 80494f2:	83 c0 04             	add    $0x4,%eax
...
08049511 <phase_2>:
 ...
 804951a:	6a 09                	push   $0x9
 804951c:	8d 45 d0             	lea    -0x30(%ebp),%eax
 804951f:	50                   	push   %eax
 ...
 8049534:	eb 59                	jmp    804958f <phase_2+0x7e>
 8049536:	8b 45 d0             	mov    -0x30(%ebp),%eax
 8049539:	3d 88 00 00 00       	cmp    $0x88,%eax
 804953e:	74 0c                	je     804954c <phase_2+0x3b>
 8049540:	e8 97 08 00 00       	call   8049ddc <explode_bomb>
 8049545:	b8 00 00 00 00       	mov    $0x0,%eax
 804954a:	eb 43                	jmp    804958f <phase_2+0x7e>
 804954c:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
 8049553:	eb 2f                	jmp    8049584 <phase_2+0x73>
 8049555:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049558:	8b 44 85 d0          	mov    -0x30(%ebp,%eax,4),%eax
 804955c:	8b 55 f4             	mov    -0xc(%ebp),%edx
 804955f:	83 ea 01             	sub    $0x1,%edx
 8049562:	8b 54 95 d0          	mov    -0x30(%ebp,%edx,4),%edx
 8049566:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 8049569:	01 c9                	add    %ecx,%ecx
 804956b:	29 ca                	sub    %ecx,%edx
 804956d:	83 c2 01             	add    $0x1,%edx
 8049570:	39 d0                	cmp    %edx,%eax
 8049572:	74 0c                	je     8049580 <phase_2+0x6f>
 8049574:	e8 63 08 00 00       	call   8049ddc <explode_bomb>
 8049579:	b8 00 00 00 00       	mov    $0x0,%eax
 804957e:	eb 0f                	jmp    804958f <phase_2+0x7e>
 8049580:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 8049584:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp)
 8049588:	7e cb                	jle    8049555 <phase_2+0x44>
...
08049591 <phase_3>:
 ...
 8049594:	83 ec 18             	sub    $0x18,%esp
 8049597:	8d 45 e8             	lea    -0x18(%ebp),%eax
 804959a:	50                   	push   %eax
 804959b:	8d 45 ec             	lea    -0x14(%ebp),%eax
 804959e:	50                   	push   %eax
 804959f:	68 c9 a1 04 08       	push   $0x804a1c9
 ...
 80495b2:	83 7d f0 01          	cmpl   $0x1,-0x10(%ebp)
 80495b6:	7f 0f                	jg     80495c7 <phase_3+0x36>
 80495b8:	e8 1f 08 00 00       	call   8049ddc <explode_bomb>
 80495bd:	b8 00 00 00 00       	mov    $0x0,%eax
 80495c2:	e9 8c 00 00 00       	jmp    8049653 <phase_3+0xc2>
 80495c7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 80495ce:	8b 45 ec             	mov    -0x14(%ebp),%eax
 80495d1:	83 e8 7d             	sub    $0x7d,%eax
 80495d4:	83 f8 08             	cmp    $0x8,%eax
 80495d7:	77 55                	ja     804962e <phase_3+0x9d>
 80495d9:	8b 04 85 d0 a1 04 08 	mov    0x804a1d0(,%eax,4),%eax
 80495e0:	ff e0                	jmp    *%eax
 80495e2:	81 45 f4 54 03 00 00 	addl   $0x354,-0xc(%ebp)
 80495e9:	81 45 f4 7c 03 00 00 	addl   $0x37c,-0xc(%ebp)
 80495f0:	81 6d f4 54 03 00 00 	subl   $0x354,-0xc(%ebp)
 80495f7:	81 45 f4 54 03 00 00 	addl   $0x354,-0xc(%ebp)
 80495fe:	81 45 f4 7c 03 00 00 	addl   $0x37c,-0xc(%ebp)
 8049605:	81 6d f4 54 03 00 00 	subl   $0x354,-0xc(%ebp)
 804960c:	81 45 f4 7c 03 00 00 	addl   $0x37c,-0xc(%ebp)
 8049613:	81 6d f4 7c 03 00 00 	subl   $0x37c,-0xc(%ebp)
 804961a:	81 45 f4 54 03 00 00 	addl   $0x354,-0xc(%ebp)
 8049621:	90                   	nop
 8049622:	8b 45 ec             	mov    -0x14(%ebp),%eax
 8049625:	3d 83 00 00 00       	cmp    $0x83,%eax
 804962a:	7f 16                	jg     8049642 <phase_3+0xb1>
 804962c:	eb 0c                	jmp    804963a <phase_3+0xa9>
 804962e:	e8 a9 07 00 00       	call   8049ddc <explode_bomb>
 8049633:	b8 00 00 00 00       	mov    $0x0,%eax
 8049638:	eb 19                	jmp    8049653 <phase_3+0xc2>
 804963a:	8b 45 e8             	mov    -0x18(%ebp),%eax
 804963d:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 8049640:	74 0c                	je     804964e <phase_3+0xbd>
 8049642:	e8 95 07 00 00       	call   8049ddc <explode_bomb>
 8049647:	b8 00 00 00 00       	mov    $0x0,%eax
 804964c:	eb 05                	jmp    8049653 <phase_3+0xc2>
...
08049655 <func4>:
 ...
 804965c:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 8049660:	7f 07                	jg     8049669 <func4+0x14>
 8049662:	b8 03 00 00 00       	mov    $0x3,%eax
 8049667:	eb 37                	jmp    80496a0 <func4+0x4b>
 8049669:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
 804966d:	75 07                	jne    8049676 <func4+0x21>
 804966f:	b8 1a 00 00 00       	mov    $0x1a,%eax
 8049674:	eb 2a                	jmp    80496a0 <func4+0x4b>
 8049676:	8b 45 08             	mov    0x8(%ebp),%eax
 8049679:	83 e8 01             	sub    $0x1,%eax
 804967c:	83 ec 0c             	sub    $0xc,%esp
 804967f:	50                   	push   %eax
 8049680:	e8 d0 ff ff ff       	call   8049655 <func4>
 8049685:	83 c4 10             	add    $0x10,%esp
 8049688:	89 c3                	mov    %eax,%ebx
 804968a:	8b 45 08             	mov    0x8(%ebp),%eax
 804968d:	83 e8 02             	sub    $0x2,%eax
 8049690:	83 ec 0c             	sub    $0xc,%esp
 8049693:	50                   	push   %eax
 8049694:	e8 bc ff ff ff       	call   8049655 <func4>
 8049699:	83 c4 10             	add    $0x10,%esp
 804969c:	d1 f8                	sar    %eax
 804969e:	01 d8                	add    %ebx,%eax
 80496a0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 80496a3:	c9                   	leave  
 80496a4:	c3                   	ret    
...
080496a5 <phase_4>:
 ...
 80496a8:	83 ec 18             	sub    $0x18,%esp
 80496ab:	8d 45 e8             	lea    -0x18(%ebp),%eax
 80496ae:	50                   	push   %eax
 80496af:	8d 45 ec             	lea    -0x14(%ebp),%eax
 80496b2:	50                   	push   %eax
 ...
 80496c3:	89 45 f4             	mov    %eax,-0xc(%ebp)
 80496c6:	83 7d f4 02          	cmpl   $0x2,-0xc(%ebp)
 80496ca:	75 08                	jne    80496d4 <phase_4+0x2f>
 80496cc:	8b 45 ec             	mov    -0x14(%ebp),%eax
 80496cf:	83 f8 07             	cmp    $0x7,%eax
 80496d2:	7f 0c                	jg     80496e0 <phase_4+0x3b>
 80496d4:	e8 03 07 00 00       	call   8049ddc <explode_bomb>
 80496d9:	b8 00 00 00 00       	mov    $0x0,%eax
 80496de:	eb 2b                	jmp    804970b <phase_4+0x66>
 80496e0:	8b 45 ec             	mov    -0x14(%ebp),%eax
 80496e3:	83 ec 0c             	sub    $0xc,%esp
 80496e6:	50                   	push   %eax
 80496e7:	e8 69 ff ff ff       	call   8049655 <func4>
 80496ec:	83 c4 10             	add    $0x10,%esp
 80496ef:	89 45 f0             	mov    %eax,-0x10(%ebp)
 80496f2:	8b 45 e8             	mov    -0x18(%ebp),%eax
 80496f5:	39 45 f0             	cmp    %eax,-0x10(%ebp)
 80496f8:	74 0c                	je     8049706 <phase_4+0x61>
 80496fa:	e8 dd 06 00 00       	call   8049ddc <explode_bomb>
 80496ff:	b8 00 00 00 00       	mov    $0x0,%eax
 8049704:	eb 05                	jmp    804970b <phase_4+0x66>
...
0804970d <phase_5>:
 ...
 8049710:	83 ec 18             	sub    $0x18,%esp
 8049713:	83 ec 0c             	sub    $0xc,%esp
 8049716:	ff 75 08             	pushl  0x8(%ebp)
 8049719:	e8 2a 04 00 00       	call   8049b48 <string_length>
 804971e:	83 c4 10             	add    $0x10,%esp
 8049721:	89 45 ec             	mov    %eax,-0x14(%ebp)
 8049724:	83 7d ec 08          	cmpl   $0x8,-0x14(%ebp)
 8049728:	74 0c                	je     8049736 <phase_5+0x29>
 804972a:	e8 ad 06 00 00       	call   8049ddc <explode_bomb>
 804972f:	b8 00 00 00 00       	mov    $0x0,%eax
 8049734:	eb 4c                	jmp    8049782 <phase_5+0x75>
 8049736:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 804973d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
 8049744:	eb 1f                	jmp    8049765 <phase_5+0x58>
 8049746:	8b 55 f4             	mov    -0xc(%ebp),%edx
 8049749:	8b 45 08             	mov    0x8(%ebp),%eax
 804974c:	01 d0                	add    %edx,%eax
 804974e:	0f b6 00             	movzbl (%eax),%eax
 8049751:	0f be c0             	movsbl %al,%eax
 8049754:	83 e0 0f             	and    $0xf,%eax
 8049757:	8b 04 85 00 c2 04 08 	mov    0x804c200(,%eax,4),%eax
 804975e:	01 45 f0             	add    %eax,-0x10(%ebp)
 8049761:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
 8049765:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
 8049769:	7e db                	jle    8049746 <phase_5+0x39>
 804976b:	83 7d f0 3f          	cmpl   $0x3f,-0x10(%ebp)
 804976f:	74 0c                	je     804977d <phase_5+0x70>
 8049771:	e8 66 06 00 00       	call   8049ddc <explode_bomb>
 8049776:	b8 00 00 00 00       	mov    $0x0,%eax
 804977b:	eb 05                	jmp    8049782 <phase_5+0x75>
 804977d:	b8 01 00 00 00       	mov    $0x1,%eax
 8049782:	c9                   	leave  
 8049783:	c3                   	ret    
...
08049784 <phase_6>:
 ...
 8049787:	83 ec 58             	sub    $0x58,%esp
 804978a:	c7 45 e8 2c c1 04 08 	movl   $0x804c12c,-0x18(%ebp)
 8049791:	83 ec 04             	sub    $0x4,%esp
 8049794:	6a 07                	push   $0x7
 8049796:	8d 45 cc             	lea    -0x34(%ebp),%eax
 8049799:	50                   	push   %eax
 ...
 80497a7:	75 0a                	jne    80497b3 <phase_6+0x2f>
 80497a9:	b8 00 00 00 00       	mov    $0x0,%eax
 80497ae:	e9 37 01 00 00       	jmp    80498ea <phase_6+0x166>
 80497b3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 80497ba:	eb 60                	jmp    804981c <phase_6+0x98>
 80497bc:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80497bf:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 80497c3:	85 c0                	test   %eax,%eax
 80497c5:	7e 0c                	jle    80497d3 <phase_6+0x4f>
 80497c7:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80497ca:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 80497ce:	83 f8 07             	cmp    $0x7,%eax
 80497d1:	7e 0f                	jle    80497e2 <phase_6+0x5e>
 80497d3:	e8 04 06 00 00       	call   8049ddc <explode_bomb>
 80497d8:	b8 00 00 00 00       	mov    $0x0,%eax
 80497dd:	e9 08 01 00 00       	jmp    80498ea <phase_6+0x166>
 80497e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80497e5:	83 c0 01             	add    $0x1,%eax
 80497e8:	89 45 ec             	mov    %eax,-0x14(%ebp)
 80497eb:	eb 25                	jmp    8049812 <phase_6+0x8e>
 80497ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
 80497f0:	8b 54 85 cc          	mov    -0x34(%ebp,%eax,4),%edx
 80497f4:	8b 45 ec             	mov    -0x14(%ebp),%eax
 80497f7:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 80497fb:	39 c2                	cmp    %eax,%edx
 80497fd:	75 0f                	jne    804980e <phase_6+0x8a>
 80497ff:	e8 d8 05 00 00       	call   8049ddc <explode_bomb>
 8049804:	b8 00 00 00 00       	mov    $0x0,%eax
 8049809:	e9 dc 00 00 00       	jmp    80498ea <phase_6+0x166>
 804980e:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
 8049812:	83 7d ec 06          	cmpl   $0x6,-0x14(%ebp)
 8049816:	7e d5                	jle    80497ed <phase_6+0x69>
 8049818:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 804981c:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 8049820:	7e 9a                	jle    80497bc <phase_6+0x38>
 8049822:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 8049829:	eb 36                	jmp    8049861 <phase_6+0xdd>
 804982b:	8b 45 e8             	mov    -0x18(%ebp),%eax
 804982e:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049831:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
 8049838:	eb 0d                	jmp    8049847 <phase_6+0xc3>
 804983a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 804983d:	8b 40 08             	mov    0x8(%eax),%eax
 8049840:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049843:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
 8049847:	8b 45 f0             	mov    -0x10(%ebp),%eax
 804984a:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 804984e:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 8049851:	7c e7                	jl     804983a <phase_6+0xb6>
 8049853:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049856:	8b 55 f4             	mov    -0xc(%ebp),%edx
 8049859:	89 54 85 b0          	mov    %edx,-0x50(%ebp,%eax,4)
 804985d:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 8049861:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 8049865:	7e c4                	jle    804982b <phase_6+0xa7>
 8049867:	8b 45 b0             	mov    -0x50(%ebp),%eax
 804986a:	89 45 e8             	mov    %eax,-0x18(%ebp)
 804986d:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8049870:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049873:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
 804987a:	eb 1a                	jmp    8049896 <phase_6+0x112>
 804987c:	8b 45 f0             	mov    -0x10(%ebp),%eax
 804987f:	8b 54 85 b0          	mov    -0x50(%ebp,%eax,4),%edx
 8049883:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049886:	89 50 08             	mov    %edx,0x8(%eax)
 8049889:	8b 45 f4             	mov    -0xc(%ebp),%eax
 804988c:	8b 40 08             	mov    0x8(%eax),%eax
 804988f:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049892:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 8049896:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 804989a:	7e e0                	jle    804987c <phase_6+0xf8>
 804989c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 804989f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
 80498a6:	8b 45 e8             	mov    -0x18(%ebp),%eax
 80498a9:	89 45 f4             	mov    %eax,-0xc(%ebp)
 80498ac:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 80498b3:	eb 2a                	jmp    80498df <phase_6+0x15b>
 80498b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80498b8:	8b 10                	mov    (%eax),%edx
 80498ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80498bd:	8b 40 08             	mov    0x8(%eax),%eax
 80498c0:	8b 00                	mov    (%eax),%eax
 80498c2:	39 c2                	cmp    %eax,%edx
 80498c4:	7e 0c                	jle    80498d2 <phase_6+0x14e>
 80498c6:	e8 11 05 00 00       	call   8049ddc <explode_bomb>
 80498cb:	b8 00 00 00 00       	mov    $0x0,%eax
 80498d0:	eb 18                	jmp    80498ea <phase_6+0x166>
 80498d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80498d5:	8b 40 08             	mov    0x8(%eax),%eax
 80498d8:	89 45 f4             	mov    %eax,-0xc(%ebp)
 80498db:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 80498df:	83 7d f0 05          	cmpl   $0x5,-0x10(%ebp)
 80498e3:	7e d0                	jle    80498b5 <phase_6+0x131>
 80498e5:	b8 01 00 00 00       	mov    $0x1,%eax
 80498ea:	c9                   	leave  
 80498eb:	c3                   	ret    
...
080498ec <fun7>:
 ...
 80498ef:	83 ec 08             	sub    $0x8,%esp
 80498f2:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 80498f6:	75 07                	jne    80498ff <fun7+0x13>
 80498f8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 80498fd:	eb 4e                	jmp    804994d <fun7+0x61>
 80498ff:	8b 45 08             	mov    0x8(%ebp),%eax
 8049902:	8b 00                	mov    (%eax),%eax
 8049904:	39 45 0c             	cmp    %eax,0xc(%ebp)
 8049907:	7d 19                	jge    8049922 <fun7+0x36>
 8049909:	8b 45 08             	mov    0x8(%ebp),%eax
 804990c:	8b 40 04             	mov    0x4(%eax),%eax
 804990f:	83 ec 08             	sub    $0x8,%esp
 8049912:	ff 75 0c             	pushl  0xc(%ebp)
 8049915:	50                   	push   %eax
 8049916:	e8 d1 ff ff ff       	call   80498ec <fun7>
 804991b:	83 c4 10             	add    $0x10,%esp
 804991e:	01 c0                	add    %eax,%eax
 8049920:	eb 2b                	jmp    804994d <fun7+0x61>
 8049922:	8b 45 08             	mov    0x8(%ebp),%eax
 8049925:	8b 00                	mov    (%eax),%eax
 8049927:	39 45 0c             	cmp    %eax,0xc(%ebp)
 804992a:	75 07                	jne    8049933 <fun7+0x47>
 804992c:	b8 00 00 00 00       	mov    $0x0,%eax
 8049931:	eb 1a                	jmp    804994d <fun7+0x61>
 8049933:	8b 45 08             	mov    0x8(%ebp),%eax
 8049936:	8b 40 08             	mov    0x8(%eax),%eax
 8049939:	83 ec 08             	sub    $0x8,%esp
 804993c:	ff 75 0c             	pushl  0xc(%ebp)
 804993f:	50                   	push   %eax
 8049940:	e8 a7 ff ff ff       	call   80498ec <fun7>
 8049945:	83 c4 10             	add    $0x10,%esp
 8049948:	01 c0                	add    %eax,%eax
 804994a:	83 c0 01             	add    $0x1,%eax
 804994d:	c9                   	leave  
 804994e:	c3                   	ret    
...
0804994f <secret_phase>:
 ...
 8049952:	83 ec 18             	sub    $0x18,%esp
 8049955:	e8 3f 03 00 00       	call   8049c99 <read_line>
 804995a:	89 45 f4             	mov    %eax,-0xc(%ebp)
 804995d:	83 ec 0c             	sub    $0xc,%esp
 8049960:	ff 75 f4             	pushl  -0xc(%ebp)
 8049963:	e8 98 f7 ff ff       	call   8049100 <atoi@plt>
 8049968:	83 c4 10             	add    $0x10,%esp
 804996b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 804996e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8049972:	7e 09                	jle    804997d <secret_phase+0x2e>
 8049974:	81 7d f0 e9 03 00 00 	cmpl   $0x3e9,-0x10(%ebp)
 804997b:	7e 0c                	jle    8049989 <secret_phase+0x3a>
 804997d:	e8 5a 04 00 00       	call   8049ddc <explode_bomb>
 8049982:	b8 00 00 00 00       	mov    $0x0,%eax
 8049987:	eb 42                	jmp    80499cb <secret_phase+0x7c>
 8049989:	83 ec 08             	sub    $0x8,%esp
 ...
 804999c:	89 45 ec             	mov    %eax,-0x14(%ebp)
 804999f:	83 7d ec 02          	cmpl   $0x2,-0x14(%ebp)
 80499a3:	74 0c                	je     80499b1 <secret_phase+0x62>
 80499a5:	e8 32 04 00 00       	call   8049ddc <explode_bomb>
 80499aa:	b8 00 00 00 00       	mov    $0x0,%eax
 80499af:	eb 1a                	jmp    80499cb <secret_phase+0x7c>
 ...
 80499c6:	b8 01 00 00 00       	mov    $0x1,%eax
 80499cb:	c9                   	leave  
 80499cc:	c3                   	ret    
...
08049aba <read_n_numbers>:
 ...
 8049abd:	83 ec 18             	sub    $0x18,%esp
 8049ac0:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 8049ac7:	eb 70                	jmp    8049b39 <read_n_numbers+0x7f>
 8049ac9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8049acd:	75 18                	jne    8049ae7 <read_n_numbers+0x2d>
 8049acf:	83 ec 08             	sub    $0x8,%esp
 8049ad2:	68 87 a2 04 08       	push   $0x804a287
 8049ad7:	ff 75 08             	pushl  0x8(%ebp)
 8049ada:	e8 11 f6 ff ff       	call   80490f0 <strtok@plt>
 8049adf:	83 c4 10             	add    $0x10,%esp
 8049ae2:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049ae5:	eb 15                	jmp    8049afc <read_n_numbers+0x42>
 8049ae7:	83 ec 08             	sub    $0x8,%esp
 8049aea:	68 87 a2 04 08       	push   $0x804a287
 8049aef:	6a 00                	push   $0x0
 8049af1:	e8 fa f5 ff ff       	call   80490f0 <strtok@plt>
 8049af6:	83 c4 10             	add    $0x10,%esp
 8049af9:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049afc:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8049b00:	74 27                	je     8049b29 <read_n_numbers+0x6f>
 8049b02:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049b05:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
 8049b0c:	8b 45 0c             	mov    0xc(%ebp),%eax
 8049b0f:	01 d0                	add    %edx,%eax
 8049b11:	83 ec 04             	sub    $0x4,%esp
 8049b14:	50                   	push   %eax
 8049b15:	68 8b a2 04 08       	push   $0x804a28b
 8049b1a:	ff 75 f4             	pushl  -0xc(%ebp)
 8049b1d:	e8 ae f5 ff ff       	call   80490d0 <__isoc99_sscanf@plt>
 8049b22:	83 c4 10             	add    $0x10,%esp
 8049b25:	85 c0                	test   %eax,%eax
 8049b27:	7f 0c                	jg     8049b35 <read_n_numbers+0x7b>
 ...
 8049b35:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 8049b39:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049b3c:	3b 45 10             	cmp    0x10(%ebp),%eax
 8049b3f:	7c 88                	jl     8049ac9 <read_n_numbers+0xf>
 8049b41:	b8 01 00 00 00       	mov    $0x1,%eax
 8049b46:	c9                   	leave  
 8049b47:	c3                   	ret    
...
08049b48 <string_length>:
 ...
 8049b51:	89 45 f8             	mov    %eax,-0x8(%ebp)
 8049b54:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
 8049b5b:	eb 08                	jmp    8049b65 <string_length+0x1d>
 8049b5d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
 8049b61:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
 8049b65:	8b 45 f8             	mov    -0x8(%ebp),%eax
 8049b68:	0f b6 00             	movzbl (%eax),%eax
 8049b6b:	84 c0                	test   %al,%al
 8049b6d:	75 ee                	jne    8049b5d <string_length+0x15>
 8049b6f:	8b 45 fc             	mov    -0x4(%ebp),%eax
 8049b72:	c9                   	leave  
 8049b73:	c3                   	ret    
...
08049b74 <strings_not_equal>:
 ...
 8049b77:	53                   	push   %ebx
 8049b78:	83 ec 10             	sub    $0x10,%esp
 8049b7b:	ff 75 08             	pushl  0x8(%ebp)
 8049b7e:	e8 c5 ff ff ff       	call   8049b48 <string_length>
 8049b83:	83 c4 04             	add    $0x4,%esp
 8049b86:	89 c3                	mov    %eax,%ebx
 8049b88:	ff 75 0c             	pushl  0xc(%ebp)
 8049b8b:	e8 b8 ff ff ff       	call   8049b48 <string_length>
 8049b90:	83 c4 04             	add    $0x4,%esp
 8049b93:	39 c3                	cmp    %eax,%ebx
 8049b95:	74 07                	je     8049b9e <strings_not_equal+0x2a>
 8049b97:	b8 01 00 00 00       	mov    $0x1,%eax
 ...
 8049bda:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 8049bdd:	c9                   	leave  
 8049bde:	c3                   	ret    
